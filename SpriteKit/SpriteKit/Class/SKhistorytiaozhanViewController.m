//
//  SKhistorytiaozhanViewController.m
//  SpriteKit
//
...
#import "SKhistorytiaozhanViewController.h"

@interface SKhistorytiaozhanViewController ()

@end

@implementation SKhistorytiaozhanViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGRect titleLabelF  = CGRectMake(5, 10, cell.frame.size.width/2-15, 24);
    ...
    CGRect titleLabelF2  = CGRectMake(cell.frame.size.width/2, 10, cell.frame.size.width-45-15, 24);
